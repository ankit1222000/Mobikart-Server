...
for(var x=0;x<req.body.product.length;x++){
 sqlquery="INSERT INTO ORDERS VALUES('"+order_id+"',"+req.body.customer_id+",'"+req.body.product[x].product+"',"+req.body.product[x].price+",'"+req.body.payment_mode+"','"+req.body.customer_name+"','"+req.body.product[x].image+"',CURRENT_DATE(),'"+time+"')"
